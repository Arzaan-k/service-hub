      ...
      <CardHeader>
        ...
        <div className="flex items-center gap-2 mt-4 flex-wrap">
          ...
          <select
            ...
            className="px-3 py-1.5 text-sm border border-border rounded-md bg-background focus:outline-none focus:ring-2 focus:ring-ring min-w-0 max-w-xs"
          ...
          <select
            ...
            className="px-3 py-1.5 text-sm border border-border rounded-md bg-background focus:outline-none focus:ring-2 focus:ring-ring min-w-0 max-w-xs truncate"
            style={{ maxWidth: '250px' }}
            title={filterDepot !== 'all' ? uniqueDepots.find(d => d?.toLowerCase() === filterDepot) || filterDepot : 'All Depots'}
          >
