  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      <AnimatedCard gradientColor="#3B82F6" className="p-6">
        ...
        <h3 className="text-4xl font-bold text-foreground tracking-tight">{stats?.totalContainers || 0}</h3>
      ...
      {/* Active Alerts */}
      <AnimatedCard gradientColor="#EF4444" className="p-6">
        <div className="flex items-center justify-between mb-4">
        ...
        <h3 className="text-4xl font-bold text-foreground tracking-tight">{stats?.activeAlerts || 0}</h3>
      ...
      {/* Service Requests */}
      <AnimatedCard gradientColor="#F97316" className="p-6">
        <div className="flex items-center justify-between mb-4">
        ...
        <h3 className="text-4xl font-bold text-foreground tracking-tight">{stats?.pendingServices || 0}</h3>
      ...
      <AnimatedCard gradientColor="#10B981" className="p-6">
        ...
        <h3 className="text-4xl font-bold text-foreground tracking-tight">{stats?.fleetUtilization || 0}%</h3>
